...
cos_2 = FitBase.FitBase(['x0', 'y0', 'a', 'period'], fitting_function,
...
# Cosine^2 with initialiser which extracts the intial period with
# an fft, only works when the x-axis is regularly spaced
cos_2_fft = FitBase.FitBase(['x0', 'y0', 'a', 'period'], fitting_function,
