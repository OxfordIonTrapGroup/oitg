...
if __name__ == "__main__":
    xs    = [0, 12.34567, -0.123456, 0.001234560000, -0.0000123456, float('nan'), 0, float('inf'), 10]
    xes   = [   1e-4,  0.00123, 0.000123, 0.000000012345, 0.0000001234, 1, float('nan'), float('inf'), 100]
